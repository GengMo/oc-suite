...
@protocol AnimatedImageViewDebugDelegate <NSObject>
@optional
- (void)debug_animatedImageView:(AnimatedImageView *)animatedImageView waitingForFrame:(NSUInteger)index duration:(NSTimeInterval)duration;
@end
#endif
...
#if defined(DEBUG) && DEBUG
@property (nonatomic, weak) id<AnimatedImageViewDebugDelegate> debug_delegate;
#endif

...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self = [super initWithFrame:frame]) {
        ...
        self.backgroundColor = customBaseViewBackgroundColor ? : [UIColor clearColor];
...
static UIColor *customBaseViewBackgroundColor  = nil;

+ (void)setBaseViewBackgroundColor:(UIColor *)backgroundColor {
    customBaseViewBackgroundColor   = backgroundColor;
}
